...
| Send buttons / lists                                | ✅ reply buttons; lists via templates | Session reply buttons: `content.kind: "buttons"`. Lists still need a template or are not sent as interactive lists.                  |
